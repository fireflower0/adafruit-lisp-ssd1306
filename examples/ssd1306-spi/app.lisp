(uiop:define-package #:ssd1306-spi/app
  (:use #:cl
        #:ssd1306-spi/wrapper/wiringpi
        #:adafruit-lisp-ssd1306/constants
        #:adafruit-lisp-ssd1306/spi)
  (:export #:main))
(in-package #:ssd1306-spi/app)
...
(defun example-draw-bmp ()
  ...
  (ssd1306-draw-string 62  8 "adafruit")
  (ssd1306-draw-string 62 16 "lisp")
  (ssd1306-draw-string 62 24 "ssd1306")
  (ssd1306-draw-string 62 40 "Github")
  (ssd1306-draw-string 62 48 "URL")
  (ssd1306-display)
  (delay 5000)
  (ssd1306-clear-display))

(defun main (&rest args)
  (ssd1306-init :rst-pin 23 :dc-pin 4 :spi-cs 1 :spi-speed 8000000)
  (example-draw-pixel)
  (example-draw-line)
  (example-draw-rect)
